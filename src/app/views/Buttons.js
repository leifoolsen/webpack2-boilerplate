...
const strokedButtons = () =>
  <section>
    ...
    <div style={{display: 'flex', flexWrap: 'wrap'}}>
      <button
        class={classnames(button['Button-default'], button['Button--stroked'])}
        type="button"
      >
        Button
      </button>
      <button
        class={classnames(button['Button-primary'], button['Button--compact'], button['Button--stroked'])}
        type="button"
      >
        Compact
      </button>
      <button
        class={classnames(button['Button-secondary'], button['Button--stroked'], button['Button--dense'])}
        type="button"
      >
        Dense
      </button>
      ...
      <button
        class={classnames(button['Button-secondary'], button['Button--stroked'])}
        type="button"
      >
        Secondary
      </button>
...
const filledButtons = () =>
  <section>
    ...
    <div style={{display: 'flex', flexWrap: 'wrap'}}>
      ...
      <button
        class={classnames(button['Button-default'], button['Button--filled'], button['Button--compact'])}
        type="button"
      >
        Compact
      </button>
      <button
        class={classnames(button['Button-primary'], button['Button--filled'], button['Button--dense'])}
        type="button"
      >
        Dense
      </button>
      ...
      <button
        class={classnames(button['Button-default'], button['Button--filled'])}
        type="button"
        disabled
      >
        Disabled
...
const raisedButtons = () =>
  <section>
    ...
    <div style={{display: 'flex', flexWrap: 'wrap'}}>
      ...
      <button
        class={classnames(button['Button-default'], button['Button--raised'], button['Button--compact'])}
        type="button"
      >
        Compact
      </button>
      <button
        class={classnames(button['Button-default'], button['Button--raised'], button['Button--dense'])}
        type="button"
      >
        Dense
      </button>
      ...
      <button
        class={classnames(button['Button-default'], button['Button--raised'])}
        type="button"
        disabled
      >
        Disabled
    ...
    <div style={{display: 'flex', flexWrap: 'wrap'}}>
      <button
        class={classnames(button['Button-default'], button['Button--stroked'], button['Button--raised'])}
        type="button"
      >
        Button
      </button>
      ...
      <button
        class={classnames(button['Button-secondary'], button['Button--stroked'], button['Button--raised'])}
        type="button"
      >
        Secondary
      </button>
    ...
    <div style={{display: 'flex', flexWrap: 'wrap'}}>
      <button
        class={classnames(button['Button-default'], button['Button--filled'], button['Button--raised'])}
        type="button"
      >
        Button
      </button>
      ...
      <button
        class={classnames(button['Button-secondary'], button['Button--filled'], button['Button--raised'])}
        type="button"
      >
        Secondary
      </button>
    ...
    <div style={{display: 'flex', flexWrap: 'wrap'}}>
      <button
        class={classnames(button['Button-info'], button['Button--filled'], button['Button--raised'])}
        type="button"
      >
        <i aria-hidden="true" class={classnames('material-icons', color.infoDark2)}>info_outline</i><span>Info</span>
      </button>
      <button
        class={classnames(button['Button-success'], button['Button--filled'], button['Button--raised'])}
        type="button"
      >
        <span>Success</span><i aria-hidden="true" class={classnames('material-icons', color.successDark2)}>check</i>
      </button>
      <button
        class={classnames(button['Button-warning'], button['Button--filled'], button['Button--raised'])}
        type="button"
      >
        <span>Warning</span><i aria-hidden="true" class={classnames('material-icons', color.warningDark2)}>warning</i>
      </button>
      <button
        class={classnames(button['Button-error'], button['Button--filled'], button['Button--raised'])}
        type="button"
      >
